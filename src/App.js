...
const ShadowAccordComplete = () => {
  // ======================
  // CORE STATE MANAGEMENT (Restored to working localStorage)
  // ======================
...
`;
  ...
  // =====================
  // AUTO-SAVE SYSTEM (Restored localStorage functionality)
  // =====================
  useEffect(() => {
                ...
                <button
                  onClick={async () => {
                    ...
                    if (factionChangeCreationMode) {
                      ...
                      // Also update in cloud if available
                      try {
                        ...
                        console.warn('Failed to save faction change to cloud, but saved locally:', error);
                      }
                    } else {
                      ...
                      try {
                        ...
                        console.warn('Failed to save character to cloud, but saved locally:', error);
                      }
                    }
