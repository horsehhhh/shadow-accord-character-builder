          ...
          try {
            ...
            const getSkillGrantedPowers = (character) => {
              ...
              if (character.skills?.medicine >= 1) {
                skillPowers.push({ name: 'Medicine 2', cost: 'None' }, { name: 'Sense Health', cost: 'None' }); // Health Check
              }
              if (character.skills?.medicine >= 2) {
                skillPowers.push({ name: 'Medicine 4', cost: 'None' }, { name: 'Detect Dead', cost: 'None' }, { name: 'Detect Dying', cost: 'None' }, { name: 'Detect Incapacitated', cost: 'None' }); // First Aid
              }
              if (character.skills?.medicine >= 3) {
                skillPowers.push({ name: 'Medicine 6', cost: 'None' }, { name: 'Detect Condition', cost: 'None' }); // Diagnosis
              }
