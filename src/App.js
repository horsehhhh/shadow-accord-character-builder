                ...
                {(() => {
                  ...
                  return (
                    <div className="mt-2">
                      ...
                      {character.subfaction === 'baali' && (
                        <p className="text-xs text-gray-500 mt-1">Holy Water causes 1 Agg damage if consumed. Holy Ground/Symbol causes Exposure damage.</p>
                      )}
                    </div>
                  );
                })()}
