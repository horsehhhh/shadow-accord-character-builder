        ...
        case 1: // Subfaction Selection
          ...
          return (
            <div className="space-y-6">
              ...
              {/* Ghoul - Select Potence Level 1 (Free Dot) */}
              {newCharacter.faction === 'human' && newCharacter.subfaction === 'ghoul' && (
                <div className={`${themeClasses.card} p-5 mt-5`}>
                  <h4 className="text-xl font-bold mb-2">Innate Power Trees</h4>
                  <p className="text-gray-400 mb-4">
                    As a ghoul, you have three innate vampire power trees that you can teach: <strong>Celerity, Fortitude, and Potence</strong>.
                    You receive <strong>1 free dot</strong> in Potence Level 1. You can spend XP during play to advance in any of these three trees,
                    or learn any other vampire power trees at learned prices.
                  </p>
                  
                  <div className="grid md:grid-cols-3 gap-2 mb-4">
                    <div className={`p-4 rounded-lg border-2 border-blue-400 bg-blue-400 bg-opacity-10 text-center`}>
                      <div className="text-2xl font-bold mb-1">⚔️</div>
                      <h5 className="font-bold">Celerity</h5>
                      <p className="text-xs text-gray-400">Innate (Learned prices)</p>
                    </div>
                    <div className={`p-4 rounded-lg border-2 border-blue-400 bg-blue-400 bg-opacity-10 text-center`}>
                      <div className="text-2xl font-bold mb-1">🛡️</div>
                      <h5 className="font-bold">Fortitude</h5>
                      <p className="text-xs text-gray-400">Innate (Learned prices)</p>
                    </div>
                    <div className={`p-4 rounded-lg border-2 border-green-500 bg-green-500 bg-opacity-20 text-center`}>
                      <div className="text-2xl font-bold mb-1">💪</div>
                      <h5 className="font-bold">Potence</h5>
                      <p className="text-xs text-green-300">Innate (FREE Level 1)</p>
                    </div>
                  </div>
                  
                  <div className="p-3 bg-green-600 bg-opacity-20 rounded-lg border border-green-500">
                    <p className="text-sm text-green-300">
                      ✅ <strong>Ghoul Powers:</strong> Your free Potence 1 is automatically assigned. You can upgrade this or advance in Celerity/Fortitude with XP,
                      or learn any vampire power at learned prices in character management.
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className={`${themeClasses.card} p-3`}>
                  <h4 className="font-bold mb-2">
                    Innate Powers ({newCharacter.faction === 'human' && newCharacter.subfaction === 'kinfolk' ? '1 dot' : 
                                   ...
                                   newCharacter.faction === 'human' && newCharacter.subfaction === 'ghoul' ? '1 dot (Potence 1 - Free)' : '3 dots'} to assign)
                  </h4>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {character.innateTreeIds.map(treeId => {
                          // Ghouls can select any of their innate trees (Celerity, Fortitude, Potence)
                          // This restriction was removed - ghouls now have all three
