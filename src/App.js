      ...
      case 'pdf':
        ...
        (async () => {
          try {
            ...
            const baaliNoteLines = character.subfaction === 'baali'
              ? [`<Holy>: Holy Water=Agg; Holy Ground/Symbol=Exposure`]
              : [];
            const noteLines = character.notes ? character.notes.split('\n') : [];
            const allNoteLines = [...traitLines, ...scorchLines, ...baaliNoteLines, ...noteLines];
