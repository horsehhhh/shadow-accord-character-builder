...
`;
  ...
  const exportCharacter = useCallback((character, format = 'json') => {
    ...
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
  }, [generateCharacterSheet, gameData.merits, gameData.powerTrees, gameData.skills, gameData.lores, gameData.passions, gameData.shadowArchetypes, formatDisplayText, currentVersion]);
