...
import { loadPdfFile, downloadFile } from './packages/core/src/utils/fileUtils';
import { gameData, currentVersion, changelog } from './packages/core/src/data/gameData';
import { createBlankCharacter, handleFactionChange, assignFreeLore, handleSubfactionChange, handleKinfolkTribalSelection, handleBreedSelection, handleAuspiceSelection, updateShifterInnateTreeIds, isBreedAvailableForTribe, getValidFactionChanges, handleFactionChangeTransformation, calculateXPCost, isRedundantPower, canAdvanceAtCheckIn, canReduce, calculateReductionRefund, countPowersAtLevel, isValidShifterPowerSelection, canAddShifterPower, getPowerLevelDistribution, canLearnPower, getAvailableMerits, getAvailableLores, deleteCharacter, advanceCharacter, reduceCharacter } from './packages/core/src/services/characterService';
import { generateCharacterSheet, exportCharacter } from './packages/core/src/services/exportService';
        ...
        <div className="w-full max-w-6xl mx-auto px-2 py-4 sm:px-4 sm:py-6">
          ...
          <div className="overflow-x-auto mb-5 border-b border-gray-700">
            <div className="flex space-x-1 min-w-max">
              {['overview', 'advancement', 'powers', 'lore', 'history', 'xp-tracking', 'notes', 'faction-change', 'self-nerf', 'rank-gen'].map(tab => (
                <button
                  key={tab}
